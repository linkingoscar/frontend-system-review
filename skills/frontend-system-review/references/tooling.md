...
38 项 Eval 覆盖仓库识别、引用匹配、越界行号、路径逃逸、P0 证据门、finding 指纹、跨文件语义警告、完整命令证据、基线差异、增量门禁、SARIF、评审包哈希与篡改检测、变更范围、评分、渲染、运行时 dry-run、声明式交互胶片、视觉 diff、交互失败门禁、真实浏览器采集、跨平台确定性打包、版本一致性、发布边界与规则时效。
